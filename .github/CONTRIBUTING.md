...
* Create a separate branch, for instance `patch-1` so you will not need to rebase
  ...
  ```sh
  git clone git@github.com:your_username/docker-re2c
  cd docker-re2c
...
* **2. Tag a new release**
  ...
  Tag a new version on [GitHub](https://github.com/petk/docker-re2c/releases).

* **3. Docker images**

  With a new tag release, build and push Docker images to
  [Docker Hub](https://hub.docker.com/r/petk/re2c/):
